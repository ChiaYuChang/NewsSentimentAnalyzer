...
type CompletionsRequest Request[*CompletionsRequestBody]
...
func (body CompletionsRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(body)
}

func (body *CompletionsRequestBody) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, body)
}

func (body CompletionsRequestBody) String() string {
