...
import (
	...
	languageDetector "github.com/ChiaYuChang/NewsSentimentAnalyzer/proto/language_detector"
...
func (repo APIRepo) PostPreview(w http.ResponseWriter, req *http.Request) {
	...
	go func() {
		...
		result, err := repo.Service.TX().DoCacheToStoreTx(
			ctx, cache.Query.UserId, int16(aid), cache.Query.RawQuery, 5, "{}", cnChan)
		if err != nil {
